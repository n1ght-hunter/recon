...
use windows::{
    ...
    Win32::{
        ...
        Graphics::Gdi::{
            DeleteObject, GetBitmapBits, GetObjectW, BITMAP, BITMAPINFOHEADER, HBITMAP, HGDIOBJ, BI_RGB,
        },
        System::{ProcessStatus::{K32GetModuleBaseNameW, K32GetModuleFileNameExW}, Com::{StructuredStorage, STGM_READ}},
        UI::{
            Shell::ExtractIconExW,
            WindowsAndMessaging::{DestroyIcon, GetIconInfoExW, HICON, ICONINFOEXW},
        }, Devices::Properties, Media::Audio::IMMDevice,
    },
};
